      ...
      return (
        <Card className="w-full shadow-lg border-2 border-primary/20 bg-primary/5">
             <CardHeader className="items-center text-center">
                ...
                <CardDescription>Your setup is complete. You can now manage your store.</CardDescription>
            </CardHeader>
            <CardContent>
  ...
  return (
    <Card className="w-full shadow-lg">
        <CardHeader>
            ...
            {step === 2 && <CardTitle>Step 2: Connect Your Store</CardTitle>}
            ...
            {step === 2 && <CardDescription>Connect your Shopify store to sync products and orders.</CardDescription>}
      ...
      <CardFooter>
        ...
        {step === 2 && <Button onClick={handleConnectStore} disabled={isLoading} className="w-full">
            {isLoading ? <><Loader2 className="mr-2 h-4 w-4 animate-spin" /> Connecting...</> : 'Connect to Shopify'}
        </Button>}
        {step === 3 && <Button onClick={handleNextStep} className="w-full">Go to Dashboard</Button>}
      </CardFooter>
    </Card>
  );
}
